...
class MediaInfoTests(unittest.TestCase):
    ...
    def test_url_note_and_unavailable_branches(self) -> None:
        ...
        ima_resource = self.client("get_media_info_ima_resource_success.json").get_media_info("media_test_ima")
        self.assertEqual((ima_resource.source_kind, ima_resource.access.safe_host), ("url", "res-skb.ima.qq.com"))
        self.assertNotIn("fixture-signature", repr(ima_resource))
